public class class450 implements class452 {
	...
	public class451 method8074() {
		byte var2;
		if (field2982.startsWith("win")) {
			var2 = 1;
		} else if (field2982.startsWith("mac")) {
			var2 = 2;
		} else if (field2982.startsWith("linux")) {
			var2 = 3;
		} else {
			var2 = 4;
		}
		...
		String var27 = "";
		boolean var28 = false;
		return new class451(var2, var7, var8, var9, this.field4748, this.field4751, this.field4750, false, var11, var12, var13, 0, var14, var15, var16, var17, 0, 0, 0, 0, var18, var19, var24, 0, "", "");
	}

	void method8055(String var1) {
		if (var1.startsWith("1.")) {
			this.method8058(var1);
		} else {
			this.method8057(var1);
		}

	}

	void method8058(String var1) {
		String[] var3 = var1.split("\\.");

		try {
			this.field4748 = Integer.parseInt(var3[1]);
			var3 = var3[2].split("_");
	...
	void method8057(String var1) {
		String[] var3 = var1.split("\\.");

		try {
			this.field4748 = Integer.parseInt(var3[0]);
			this.field4751 = Integer.parseInt(var3[1]);
			this.field4750 = Integer.parseInt(var3[2]);
		} catch (Exception var5) {
		}
