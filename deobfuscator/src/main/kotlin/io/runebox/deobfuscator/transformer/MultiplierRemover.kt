...
class MultiplierRemover : Transformer {
    ...
    override fun run(group: ClassGroup) {
        /*
         * Remove any place where jagex stores the getter in the LVT instead of as a const.
         * e.g.
         * int var1 = 203498724
         * if(field1 * var == -10287933) {
         *  ...
         * }
         *
         * This breaks most deobfuscators out there that remove multipliers.
         */
        ...
        Logger.info("Removed $count modulo-inverse field multipliers.")
    }
