package io.runebox.mixin.mappings;
...
import io.runebox.mixin.utils.mappings.SuperMappingFiller;
...
import static io.runebox.mixin.utils.Types.type;
    ...
    public final ClassNode mapClass(final ClassTree classTree, final IClassProvider classProvider, final ClassNode target, final ClassNode transformer) {
        ...
        for (AnnotationHolder annotation : annotationsToRemap) {
            ...
            try {
                ...
                //If this is the case it can't be a RuneBox Mixins annotation, so we can ignore it
                continue;
            }
            try {
