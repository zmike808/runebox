package io.runebox.mixin.utils.annotations;

import io.runebox.mixin.MixinManager;
import io.runebox.mixin.utils.Types;
...
public class AnnotationParser<T extends Annotation> {
     ...
     * @param mixinManager The transformer manager to get the class tree and class provider from
     * @param values             The raw values of the annotation
     * @return The new instance
     */
    public static <T extends Annotation> T parse(final Class<T> type, final MixinManager mixinManager, final Map<String, Object> values) {
        return new AnnotationParser<>(type, mixinManager.getClassTree(), mixinManager.getClassProvider()).parse(values);
    }
    ...
    private void defineBase() {
        ...
        this.node.visit(Opcodes.V1_8, Opcodes.ACC_PUBLIC, ClassDefiner.generateClassName("AnnotationWrapper"), null, Types.IN_Object, new String[]{Types.internalName(this.type), Types.internalName(IParsedAnnotation.class)});

        { //fields
            this.node.visitField(Opcodes.ACC_PRIVATE, "classTree", Types.typeDescriptor(ClassTree.class), null, null).visitEnd();
            this.node.visitField(Opcodes.ACC_PRIVATE, "classProvider", Types.typeDescriptor(IClassProvider.class), null, null).visitEnd();
            this.node.visitField(Opcodes.ACC_PRIVATE, "values", Types.typeDescriptor(Map.class), null, null).visitEnd();
        }

        { //<init>
            MethodVisitor constructor = this.node.visitMethod(Opcodes.ACC_PUBLIC, Types.MN_Init, Types.methodDescriptor(void.class, ClassTree.class, IClassProvider.class, Map.class), null, null);
            constructor.visitVarInsn(Opcodes.ALOAD, 0);
            constructor.visitMethodInsn(Opcodes.INVOKESPECIAL, Types.IN_Object, Types.MN_Init, Types.MD_Void, false);

            constructor.visitVarInsn(Opcodes.ALOAD, 0);
            constructor.visitVarInsn(Opcodes.ALOAD, 1);
            constructor.visitFieldInsn(Opcodes.PUTFIELD, this.node.name, "classTree", Types.typeDescriptor(ClassTree.class));

            constructor.visitVarInsn(Opcodes.ALOAD, 0);
            constructor.visitVarInsn(Opcodes.ALOAD, 2);
            constructor.visitFieldInsn(Opcodes.PUTFIELD, this.node.name, "classProvider", Types.typeDescriptor(IClassProvider.class));

            constructor.visitVarInsn(Opcodes.ALOAD, 0);
            constructor.visitVarInsn(Opcodes.ALOAD, 3);
            constructor.visitFieldInsn(Opcodes.PUTFIELD, this.node.name, "values", Types.typeDescriptor(Map.class));

            constructor.visitInsn(Opcodes.RETURN);
            constructor.visitEnd();
        }
        { //equals
            MethodVisitor equals = this.node.visitMethod(Opcodes.ACC_PUBLIC, "equals", Types.methodDescriptor(boolean.class, Object.class), null, null);
            equals.visitInsn(Opcodes.ICONST_0);
            equals.visitInsn(Opcodes.IRETURN);
            equals.visitEnd();
        }
        { //hashCode
            MethodVisitor hashCode = this.node.visitMethod(Opcodes.ACC_PUBLIC, "hashCode", Types.methodDescriptor(int.class), null, null);
            hashCode.visitInsn(Opcodes.ICONST_0);
            hashCode.visitInsn(Opcodes.IRETURN);
            hashCode.visitEnd();
        }
        { //toString
            MethodVisitor toString = this.node.visitMethod(Opcodes.ACC_PUBLIC, "toString", Types.methodDescriptor(String.class), null, null);
            toString.visitLdcInsn("AnnotationWrapper");
            toString.visitInsn(Opcodes.ARETURN);
            toString.visitEnd();
        }
        { //annotationType
            MethodVisitor annotationType = this.node.visitMethod(Opcodes.ACC_PUBLIC, "annotationType", Types.methodDescriptor(Class.class), null, null);
            annotationType.visitLdcInsn(Types.type(this.type));
            annotationType.visitInsn(Opcodes.ARETURN);
            annotationType.visitEnd();
        }
        { //getValues
            MethodVisitor getValues = this.node.visitMethod(Opcodes.ACC_PUBLIC, "getValues", Types.methodDescriptor(Map.class), null, null);
            getValues.visitVarInsn(Opcodes.ALOAD, 0);
            getValues.visitFieldInsn(Opcodes.GETFIELD, this.node.name, "values", Types.typeDescriptor(Map.class));
            getValues.visitInsn(Opcodes.ARETURN);
            getValues.visitEnd();
        }
        { //wasSet
            MethodVisitor wasSet = this.node.visitMethod(Opcodes.ACC_PUBLIC, "wasSet", Types.methodDescriptor(boolean.class, String.class), null, null);
            for (String value : this.values.keySet()) {
                ...
                wasSet.visitMethodInsn(Opcodes.INVOKEVIRTUAL, Types.IN_String, "equals", Types.methodDescriptor(boolean.class, Object.class), false);
    ...
    private void declareMethods() {
        for (Method method : this.type.getDeclaredMethods()) {
            MethodVisitor methodVisitor = this.node.visitMethod(Opcodes.ACC_PUBLIC, method.getName(), Types.methodDescriptor(method), null, null);
    ...
    private void visitEnum(final MethodVisitor methodVisitor, final Object value) {
        if (value instanceof Enum<?>) {
            Enum<?> e = (Enum<?>) value;
            methodVisitor.visitFieldInsn(Opcodes.GETSTATIC, Types.internalName(e.getDeclaringClass()), e.name(), Types.typeDescriptor(e.getDeclaringClass()));
        } else if (value instanceof String[]) {
            String[] enumValue = (String[]) value;
            methodVisitor.visitFieldInsn(Opcodes.GETSTATIC, Types.internalName(enumValue[0]), enumValue[1], enumValue[0]);
        } else {
    ...
    private void visitAnnotation(final MethodVisitor methodVisitor, final Object value) {
        Type annotationType;
        if (value instanceof Annotation) annotationType = Types.type(((Annotation) value).annotationType());
        else if (value instanceof AnnotationNode) annotationType = Types.type(((AnnotationNode) value).desc);
        ...
        methodVisitor.visitFieldInsn(Opcodes.GETFIELD, this.node.name, "classTree", Types.typeDescriptor(ClassTree.class));
        methodVisitor.visitVarInsn(Opcodes.ALOAD, 0);
        methodVisitor.visitFieldInsn(Opcodes.GETFIELD, this.node.name, "classProvider", Types.typeDescriptor(IClassProvider.class));
        methodVisitor.visitTypeInsn(Opcodes.NEW, Types.internalName(HashMap.class));
        methodVisitor.visitInsn(Opcodes.DUP);
        methodVisitor.visitMethodInsn(Opcodes.INVOKESPECIAL, Types.internalName(HashMap.class), Types.MN_Init, Types.MD_Void, false);
        if (value instanceof Annotation) {
            ...
            for (Method method : a.annotationType().getDeclaredMethods()) {
                ...
                methodVisitor.visitMethodInsn(Opcodes.INVOKEINTERFACE, Types.internalName(Map.class), "put", Types.methodDescriptor(Object.class, Object.class, Object.class), true);
        ...
        methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, Types.internalName(AnnotationParser.class), "parse", Types.methodDescriptor(Annotation.class, Class.class, ClassTree.class, IClassProvider.class, Map.class), false);
        methodVisitor.visitTypeInsn(Opcodes.CHECKCAST, Types.internalName(annotationType));
    }
    ...
    private void visitArray(final MethodVisitor methodVisitor, final Class<?> arrayType, final Object value) {
        if (value instanceof Object[]) {
            ...
            methodVisitor.visitTypeInsn(Opcodes.ANEWARRAY, Types.internalName(arrayType));
    ...
    private void visitPrimitiveWrap(final MethodVisitor methodVisitor, final Class<?> type) {
        if (type.equals(boolean.class) || type.equals(Boolean.class)) {
            methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, Types.IN_Boolean, "valueOf", Types.methodDescriptor(Boolean.class, boolean.class), false);
        } else if (type.equals(byte.class) || type.equals(Byte.class)) {
            methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, Types.IN_Byte, "valueOf", Types.methodDescriptor(Byte.class, byte.class), false);
        } else if (type.equals(short.class) || type.equals(Short.class)) {
            methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, Types.IN_Short, "valueOf", Types.methodDescriptor(Short.class, short.class), false);
        } else if (type.equals(char.class) || type.equals(Character.class)) {
            methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, Types.IN_Character, "valueOf", Types.methodDescriptor(Character.class, char.class), false);
        } else if (type.equals(int.class) || type.equals(Integer.class)) {
            methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, Types.IN_Integer, "valueOf", Types.methodDescriptor(Integer.class, int.class), false);
        } else if (type.equals(long.class) || type.equals(Long.class)) {
            methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, Types.IN_Long, "valueOf", Types.methodDescriptor(Long.class, long.class), false);
        } else if (type.equals(float.class) || type.equals(Float.class)) {
            methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, Types.IN_Float, "valueOf", Types.methodDescriptor(Float.class, float.class), false);
        } else if (type.equals(double.class) || type.equals(Double.class)) {
            methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, Types.IN_Double, "valueOf", Types.methodDescriptor(Double.class, double.class), false);
        } else if (type.equals(String.class)) {
            methodVisitor.visitMethodInsn(Opcodes.INVOKESTATIC, Types.IN_String, "valueOf", Types.methodDescriptor(String.class, Object.class), false);
        }
    }
    ...
    private void visitType(final MethodVisitor methodVisitor, final Object typeOrClass) {
        if (Type.VOID_TYPE.equals(typeOrClass) || void.class.equals(typeOrClass)) {
            methodVisitor.visitFieldInsn(Opcodes.GETSTATIC, Types.IN_Void, "TYPE", "Ljava/lang/Class;");
        } else if (Type.BOOLEAN_TYPE.equals(typeOrClass) || boolean.class.equals(typeOrClass)) {
            methodVisitor.visitFieldInsn(Opcodes.GETSTATIC, Types.IN_Boolean, "TYPE", "Ljava/lang/Class;");
        } else if (Type.BYTE_TYPE.equals(typeOrClass) || byte.class.equals(typeOrClass)) {
            methodVisitor.visitFieldInsn(Opcodes.GETSTATIC, Types.IN_Byte, "TYPE", "Ljava/lang/Class;");
        } else if (Type.SHORT_TYPE.equals(typeOrClass) || short.class.equals(typeOrClass)) {
            methodVisitor.visitFieldInsn(Opcodes.GETSTATIC, Types.IN_Short, "TYPE", "Ljava/lang/Class;");
        } else if (Type.CHAR_TYPE.equals(typeOrClass) || char.class.equals(typeOrClass)) {
            methodVisitor.visitFieldInsn(Opcodes.GETSTATIC, Types.IN_Character, "TYPE", "Ljava/lang/Class;");
        } else if (Type.INT_TYPE.equals(typeOrClass) || int.class.equals(typeOrClass)) {
            methodVisitor.visitFieldInsn(Opcodes.GETSTATIC, Types.IN_Integer, "TYPE", "Ljava/lang/Class;");
        } else if (Type.LONG_TYPE.equals(typeOrClass) || long.class.equals(typeOrClass)) {
            methodVisitor.visitFieldInsn(Opcodes.GETSTATIC, Types.IN_Long, "TYPE", "Ljava/lang/Class;");
        } else if (Type.FLOAT_TYPE.equals(typeOrClass) || float.class.equals(typeOrClass)) {
            methodVisitor.visitFieldInsn(Opcodes.GETSTATIC, Types.IN_Float, "TYPE", "Ljava/lang/Class;");
        } else if (Type.DOUBLE_TYPE.equals(typeOrClass) || double.class.equals(typeOrClass)) {
            methodVisitor.visitFieldInsn(Opcodes.GETSTATIC, Types.IN_Double, "TYPE", "Ljava/lang/Class;");
        } else if (typeOrClass instanceof Class<?>) {
            methodVisitor.visitLdcInsn(Types.type(typeOrClass));
