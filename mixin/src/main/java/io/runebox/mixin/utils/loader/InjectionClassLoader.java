...
public class InjectionClassLoader extends URLClassLoader {
    ...
    public InjectionClassLoader(final MixinManager mixinManager, final URL... urls) {
        this(mixinManager, InjectionClassLoader.class.getClassLoader(), urls);
    }

    public InjectionClassLoader(final MixinManager mixinManager, final ClassLoader parent, final URL... urls) {
        super(urls, null);
    ...
    protected Class<?> findClass(final String name) throws ClassNotFoundException {
        ...
        try {
            ...
            byte[] transformedClassBytes = this.mixinManager.transform(name, classBytes);
     ...
     */
    public MixinManager getTransformerManager() {
        return this.mixinManager;
    }
