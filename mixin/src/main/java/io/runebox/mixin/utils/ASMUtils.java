...
public class ASMUtils {
    ...
    public static InsnList getCast(final Type wantedType) {
        ...
        if (wantedType.equals(Type.BOOLEAN_TYPE)) {
            list.add(new TypeInsnNode(Opcodes.CHECKCAST, Types.IN_Boolean));
            list.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, Types.IN_Boolean, "booleanValue", Types.methodDescriptor(boolean.class), false));
        } else if (wantedType.equals(Type.BYTE_TYPE)) {
            list.add(new TypeInsnNode(Opcodes.CHECKCAST, Types.IN_Byte));
            list.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, Types.IN_Byte, "byteValue", Types.methodDescriptor(byte.class), false));
        } else if (wantedType.equals(Type.CHAR_TYPE)) {
            list.add(new TypeInsnNode(Opcodes.CHECKCAST, Types.IN_Character));
            list.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, Types.IN_Character, "charValue", Types.methodDescriptor(char.class), false));
        } else if (wantedType.equals(Type.SHORT_TYPE)) {
            list.add(new TypeInsnNode(Opcodes.CHECKCAST, Types.IN_Short));
            list.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, Types.IN_Short, "shortValue", Types.methodDescriptor(short.class), false));
        } else if (wantedType.equals(Type.INT_TYPE)) {
            list.add(new TypeInsnNode(Opcodes.CHECKCAST, Types.IN_Integer));
            list.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, Types.IN_Integer, "intValue", Types.methodDescriptor(int.class), false));
        } else if (wantedType.equals(Type.FLOAT_TYPE)) {
            list.add(new TypeInsnNode(Opcodes.CHECKCAST, Types.IN_Float));
            list.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, Types.IN_Float, "floatValue", Types.methodDescriptor(float.class), false));
        } else if (wantedType.equals(Type.LONG_TYPE)) {
            list.add(new TypeInsnNode(Opcodes.CHECKCAST, Types.IN_Long));
            list.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, Types.IN_Long, "longValue", Types.methodDescriptor(long.class), false));
        } else if (wantedType.equals(Type.DOUBLE_TYPE)) {
            list.add(new TypeInsnNode(Opcodes.CHECKCAST, Types.IN_Double));
            list.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, Types.IN_Double, "doubleValue", Types.methodDescriptor(double.class), false));
        } else {
    ...
    public static AbstractInsnNode getPrimitiveToObject(final Type primitive) {
        if (primitive.equals(Type.BOOLEAN_TYPE)) {
            return new MethodInsnNode(Opcodes.INVOKESTATIC, Types.IN_Boolean, "valueOf", Types.methodDescriptor(Boolean.class, boolean.class), false);
        } else if (primitive.equals(Type.BYTE_TYPE)) {
            return new MethodInsnNode(Opcodes.INVOKESTATIC, Types.IN_Byte, "valueOf", Types.methodDescriptor(Byte.class, byte.class), false);
        } else if (primitive.equals(Type.SHORT_TYPE)) {
            return new MethodInsnNode(Opcodes.INVOKESTATIC, Types.IN_Short, "valueOf", Types.methodDescriptor(Short.class, short.class), false);
        } else if (primitive.equals(Type.CHAR_TYPE)) {
            return new MethodInsnNode(Opcodes.INVOKESTATIC, Types.IN_Character, "valueOf", Types.methodDescriptor(Character.class, char.class), false);
        } else if (primitive.equals(Type.INT_TYPE)) {
            return new MethodInsnNode(Opcodes.INVOKESTATIC, Types.IN_Integer, "valueOf", Types.methodDescriptor(Integer.class, int.class), false);
        } else if (primitive.equals(Type.LONG_TYPE)) {
            return new MethodInsnNode(Opcodes.INVOKESTATIC, Types.IN_Long, "valueOf", Types.methodDescriptor(Long.class, long.class), false);
        } else if (primitive.equals(Type.FLOAT_TYPE)) {
            return new MethodInsnNode(Opcodes.INVOKESTATIC, Types.IN_Float, "valueOf", Types.methodDescriptor(Float.class, float.class), false);
        } else if (primitive.equals(Type.DOUBLE_TYPE)) {
            return new MethodInsnNode(Opcodes.INVOKESTATIC, Types.IN_Double, "valueOf", Types.methodDescriptor(Double.class, double.class), false);
        } else {
            return null;
        }
    }
    ...
    public static ClassNode createEmptyClass(final String name) {
        ClassNode node = new ClassNode();
        node.visit(Opcodes.V1_8, Opcodes.ACC_PUBLIC, slash(name), null, Types.IN_Object, null);

        MethodNode constructor = new MethodNode(Opcodes.ACC_PUBLIC, Types.MN_Init, Types.MD_Void, null, null);
        constructor.instructions.add(new VarInsnNode(Opcodes.ALOAD, 0));
        constructor.instructions.add(new MethodInsnNode(Opcodes.INVOKESPECIAL, Types.IN_Object, Types.MN_Init, Types.MD_Void));
