...
import io.runebox.mixin.annotation.injection.CWrapCatch;
...
public class CWrapCatchAnnotationHandler extends RemovingTargetAnnotationHandler<CWrapCatch> {
    ...
    @Override
    public void transform(CWrapCatch annotation, MixinManager mixinManager, Map<String, IInjectionTarget> injectionTargets, ClassNode transformedClass, ClassNode transformer, MethodNode transformerMethod, MethodNode target) {
