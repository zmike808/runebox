...
import io.runebox.mixin.annotation.injection.CModifyConstant;
...
public class CModifyConstantAnnotationHandler extends RemovingAnnotationHandler<CModifyConstant> implements IInjectionTarget {
    ...
    @Override
    public void transform(CModifyConstant annotation, MixinManager mixinManager, Map<String, IInjectionTarget> injectionTargets, ClassNode transformedClass, ClassNode transformer, MethodNode transformerMethod) {
